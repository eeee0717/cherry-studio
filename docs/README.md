...
| [Local Models](./references/ai/local-models.md) | Local model subsystem — the bundle catalog, verified acquisition, on-disk state, and utility-process inference over installed models |
